<template>
	<el-card>
		...
		<el-table :data="adminStore.list" row-key="id" :border="true" v-loading="adminStore.loading">
			...
			<el-table-column label="操作" width="180">
				<template #default="scope">
					...
					<el-button v-if="scope.row.is_admin != 1" size="small" type="danger"
		...
		<Pagination :total="adminStore.total" @paginationData="paginationData"></Pagination>
	</el-card>
</template>
