	...
	<el-card>
		...
		<el-form label-width="120px" v-loading="permissionStore.loading">
			<el-form-item label="关联菜单" class="required">
				<el-cascader class="el-col-12" v-model="form.menu" clearable filterable placeholder="请选择"
					:options="menuStore.treeList" :props="cascaderConfig">
				</el-cascader>
			</el-form-item>
			<el-form-item label="接口地址" class="required">
				<el-input class="el-col-12" type="textarea" :rows="5" v-model="form.uri"
